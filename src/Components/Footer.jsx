...
const Footer = () => {
    ...
    <div className="container p-6 mx-auto">
            ...
            <div className="w-full -mx-6 lg:w-2/5">
                <div className="px-6">
                    <a href="#" className="flex items-center">
                        <img className="w-12 mr-2" src={logo} alt="" /> <span className="font-extrabold text-xl">Mastaar</span>
                    </a>
        ...
        <div>
            <p className="text-center text-gray-500 dark:text-gray-400">© Mastaar - All rights reserved</p>
        </div>
    </div>
</footer>
        </div>
